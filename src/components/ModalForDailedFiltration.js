...
export default function ModalForDailedFiltration() {
  ...
  return (
    <div>
      <Button variant='contained' onClick={handleOpen}>Detallı filtrasiya</Button>
      <Modal border="none"
        open={open}
        onClose={handleClose}
      ...
      <FormControl fullWidth sx={{margin:"2%"}}>
        <InputLabel id="demo-simple-select-label">Kompüter biliyi</InputLabel>
        <Select
          labelId="demo-simple-select-label"
          id="demo-simple-select"
          value={knowledge}
      ...
      <FormControl fullWidth sx={{margin:"2%"}}>
        <InputLabel id="demo-simple-select-label">Təhsil səviyyəsi</InputLabel>
        <Select
          labelId="demo-simple-select-label"
          id="demo-simple-select"
          value={education}
...
<Button  onClick={handleClose} variant="contained" sx={{margin:"2%"}}> Filtr et</Button>
        </Box>
      </Modal>
    </div>
  );
